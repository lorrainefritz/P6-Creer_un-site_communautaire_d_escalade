...
function validate() {
	document.getElementById("title_text_danger").innerHTML = "";
	document.getElementById("image_text_danger").innerHTML = "";
	document.getElementById("secteur_text_danger").innerHTML = "";
	document.getElementById("longueur_text_danger").innerHTML = "";
	document.getElementById("nombreDeVoies_text_danger").innerHTML = "";
	
	
	if (emptyTitle()) {
		document.getElementById("title_text_danger").innerHTML = "Le champs titre est vide(signé JS)";
